...
class Square:
    ...
    def setValue(self, value, blanks, board): # sets the value and discards stuff from neighbours attributes and discards itself from blanks
        self.values = value
        blanks.discard(self)
...
def solve(board, blanks): # solves and returns board (a bit randomness is involved. only single solves)
